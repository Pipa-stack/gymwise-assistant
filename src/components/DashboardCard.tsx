...
const DashboardCard = ({
  ...
  return (
    <div className={cn(
      "group rounded-xl border bg-card p-6 shadow-sm transition-all duration-300 hover:shadow-md relative overflow-hidden",
      className
    )}>
      ...
      <div className="flex justify-between relative z-10">
        ...
        <div className="rounded-full bg-primary/10 p-3.5 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors duration-300">
          {icon}
        </div>
      </div>
